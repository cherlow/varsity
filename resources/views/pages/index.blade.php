        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-12 col-sm-12 align-self-bottom">
                <div class="left-heading">
                    <h2 class="section-title">Your Software Development Dream-team</h2>
                </div>
                <div class="left-text">
        ...
        <div class="row">
            ...
            <div class="offset-lg-3 col-lg-6">
                <div class="center-text">
                    <p>We build and transform businesses through strategy, design and development.</p>
                </div>
            </div>
        </div>
        <!-- ***** Home Services Start ***** -->
                ...
                <ul class="features">
                    <li data-scroll-reveal="enter bottom move 30px over 0.6s after 0.2s">
                        ...
                        <div class="text">
                            ...
                            <p>Simplicity is the ultimate sophistication. Work with our design team to create an elegant design that incorporates the latest UI and UX trends.</p>
                        </div>
                    </li>
                    <li data-scroll-reveal="enter bottom move 30px over 0.6s after 0.3s">
                        ...
                        <div class="text">
                            ...
                            <p>Deadlines are important to us. Our Agile Development process has clear milestones to ensure development happens on a timely basis.</p>
                        </div>
                    </li>
                    <li data-scroll-reveal="enter bottom move 30px over 0.6s after 0.4s">
                        ...
                        <div class="text">
                            ...
                            <p>During Discovery, Designing and Development phases, our technical team always there to provide suggestions and edits that improvise the product.</p>
                        </div>
                    </li>
                    <li data-scroll-reveal="enter bottom move 30px over 0.6s after 0.5s">
                        ...
                        <div class="text">
                            <h5 class="title">Product marketing</h5>
                            <p>No product launch plan is complete without the proper marketing, PR and engagement tools to help it get discovered and retain users.</p>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix-big" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                <img src="assets/images/blue-2.png" class="img-fluid d-block mx-auto" alt="App">
            </div>
...
<section class="parallax" data-image="assets/images/photos/parallax.jpg">
    <div class="parallax-content">
        <div class="container">
            <div class="row">
                <div class="offset-lg-3 col-lg-6">
                    <div class="info" style="padding-top: 50px; padding-bottom: 30px;">
                        <h1> Work Process</h1>
